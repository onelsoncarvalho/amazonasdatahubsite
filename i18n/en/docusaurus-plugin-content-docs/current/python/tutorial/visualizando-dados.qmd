...
Utilizing the ```prf_amazonas``` database, we can perform analyses of accidents recorded by the Federal Highway Police (PRF) in the state of Amazonas in the year 2025.

We can check the frequency of accidents by weather condition and identify which of these conditions presents a higher frequency of accidents.
