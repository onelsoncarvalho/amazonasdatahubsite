...
Até o momento, o pacote `amazonasdatahub` conta com cinco bases de dados para você, estudante, estatístico ou entusiasta, para analisar e aplicar métodos estatísticos.
