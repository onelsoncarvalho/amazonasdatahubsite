...
Usando o `dplyr` e o `ggplot2` para fazer análises de forma prática e
rápida:
...
Podemos plotar os gráficos do tipo boxplot para termos noções dos
valores outliers.

![](visualizando-dados.markdown_strict_files/figure-markdown_strict/unnamed-chunk-4-1.png)

Podemos concluir que esses valores “0” correspondem a dados ausentes
(NA), os quais foram preenchidos com o valor zero. Iremos substituir
esses valores zero por NAs.
